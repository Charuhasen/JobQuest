...
public class GraphicDesignActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Graphic Design");
        ...
        //Query
        Query query = fStore.collection("GraphicDesign");
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if (documentSnapshot.exists()) {
                                    ...
                                    if (isVerified.compareTo("0") == 0){
                                        Toast.makeText(GraphicDesignActivity.this, "Please Verify Mail!", Toast.LENGTH_SHORT).show();
                                    }else{
                                        ...
                                        db.set(addApplicant);
                                        Toast.makeText(GraphicDesignActivity.this, "Successful Apply!", Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    //Add Code Here
                                }
